...
export const wsConnect = createAction<string, typeof WS_ORDER_HISTORY_CONNECTION_START>(WS_ORDER_HISTORY_CONNECTION_START);
...
export const wsMessage = createAction<any, typeof WS_ORDER_HISTORY_GET_MESSAGE>(WS_ORDER_HISTORY_GET_MESSAGE);
export const wsError = createAction<string, typeof WS_ORDER_HISTORY_CONNECTION_ERROR>(WS_ORDER_HISTORY_CONNECTION_ERROR);